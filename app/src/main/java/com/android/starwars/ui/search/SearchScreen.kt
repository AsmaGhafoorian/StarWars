...
fun SearchScreen(
    ...
    Column(modifier = Modifier
        ...
        SearchBox(
            ...
            data.results?.let { SearchContent(data = it, isLoading =  isLoading,
                { viewModel.setEvent(SearchContract.Event.search(query, false))} ) }
...
@Composable
fun SearchContent(data: List<Characters>, isLoading: Boolean, loadMoreItems : () -> Unit){
